 ...
 */
@Repository
public class ActivatFormacioDaoImpl implements Dao<ActivitatFormacio, Integer> {
     ...
     * {@inheritDoc}
     *
     * @param id the activity identifier to look up
     * @return the matching {@link ActivitatFormacio}, or {@code null} if not found
     */
    @Override
    public ActivitatFormacio getByID(Integer id) {
     ...
     * {@inheritDoc}
     *
     * @return a list of all {@link ActivitatFormacio} records
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @param entity the {@link ActivitatFormacio} to persist
     */
    @Override
    public void save(ActivitatFormacio entity) {
        // TODO Auto-generated method stub
     ...
     * {@inheritDoc}
     *
     * @param entity the {@link ActivitatFormacio} containing updated values
     */
    @Override
    public void update(ActivitatFormacio entity) {
        // TODO Auto-generated method stub
     ...
     * {@inheritDoc}
     *
     * @param entity the {@link ActivitatFormacio} to remove
     */
    @Override
    public void delete(ActivitatFormacio entity) {
        // TODO Auto-generated method stub
     ...
     * {@inheritDoc}
     *
     * @param id the identifier of the activity to remove
     */
    @Override
